...
-- set('n', '<leader>bf', '<cmd>tabnew %<CR>',
--     { desc = 'Ta[B] open current bu[F]fer in new tab' }
-- )
...
set(
    { 'n', 'v' },
    '<leader>y', [["+y]], { desc = 'Cop[Y] selection to system clipboard' }
)
-- set('v', '<leader>y', [["+y]], { desc = 'Cop[Y] selection to system clipboard' })

set(
    { 'n', 'v' },
    '<leader>Y', [["+Y]], { desc = 'Cop[Y] line to system clipboard' }
)
...
set(
    { 'n', 'v' },
    '<leader>d', [["_d]], { desc = '[D]elete to void register' }
)
...
-- set('n', '<leader>Df', '<cmd>Telescope diagnostics bufnr=0<CR>',
--     { desc = 'List all diagnostics for current buffer' }
-- )
